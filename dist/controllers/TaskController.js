...
class TaskController {
    static createTask = async (req, res) => {
        //ya con el proyecto validado...
        try {
            const task = new Task_1.default(req.body);
            task.project = req.project.id;
            req.project.tasks.push(task.id);
            //await task.save()  //Estos dos await es lo mismo que el de abajo (await Promise.all.....)
    ...
    static getProjectTask = async (req, res) => {
        try {
    ...
    static updateTask = async (req, res) => {
        try {
            ...
            req.task.responsible = req.body.responsible;
